      ...
      <header className="header">
        ...
        <div className="nav-container">
          <ul className="nav-links">
            ...
            <li><Link to="/shop">Paquetes</Link></li>
      ...
      <main className="main-container">
        ...
        <div className="cart-layout">
          <div className="cart-items">
            ...
            <div className="cart-item">
              ...
              <div className="item-details">
                <div className="item-header">
                  <div>
                    <h3 className="item-title">Mili Paquete</h3>
                    <p className="item-artist">Mili</p>
                    <select className="format-select">
                      <option>Formato: Fisco (Vinilo)</option>
                      <option>Formato: Digital (Lossless)</option>
                    </select>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div className="item-price">$95.00</div>
                    <div className="item-discount-text">Hasta un 50% de descuento</div>
                  </div>
                </div>
            ...
            <div className="cart-item">
              ...
              <div className="item-details">
                <div className="item-header">
                  <div>
                    <h3 className="item-title">Gorillaz Paquete</h3>
                  ...
                  <div style={{ textAlign: 'right' }}>
                    <div className="item-price">$95.00</div>
                    <div className="item-discount-text">Hasta un 15% de descuento</div>
                  </div>
                </div>
                <div className="item-footer">
                  <div className="quantity-control">
          ...
          <div className="order-summary">
            ...
            <Link to="/shipping" className="btn-checkout">Proceder al Checkout</Link>
          </div>
        </div>
      </main>
