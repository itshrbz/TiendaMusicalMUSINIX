    ...
    <>
      ...
      <main className="container">
        <section className="hero">
          <h1>Musinix Musica, Donde sea, Cuando sea</h1>
          <div className="logo-box">
            <h2>MUSINIX</h2>
            <p>TIENDA DE MÚSICA ONLINE</p>
          </div>
        </section>
        ...
        <section className="section">
          <h2>Introducción</h2>
          <p>
            Musinix es una tienda de música en línea creada para personas que disfrutan de la música digital y física.
            Los usuarios pueden comprar álbumes, paquetes, vinilos y otros productos musicales en un solo lugar.
          </p>
        </section>

        <section className="section">
          <h2> ¿Por qué Musinix?</h2>

          <div className="cards-3">
            <div className="info-card">
              <h3>Compra Fácil</h3>
              <p>Compra productos musicales de manera simple y rápida.</p>
            </div>

            <div className="info-card">
              <h3>Biblioteca Digital</h3>
              <p>Accede a tu música digital comprada desde tu biblioteca personal.</p>
            </div>

            <div className="info-card">
              <h3>Productos Físicos</h3>
              <p>Encuentra álbumes, paquetes y formatos musicales físicos.</p>
            </div>
          </div>
        </section>

        <section className="section">
          <h2>Caras de Musinix</h2>

          <div className="cards-3">
            <div className="person-card">
              <div className="image-placeholder">Image</div>
              <h3>Amantes de la Música</h3>
              <p>Personas que quieren descubrir y coleccionar música.</p>
            </div>

            <div className="person-card">
              <div className="image-placeholder">Image</div>
              <h3>Colectores</h3>
              <p>Usuarios interesados en álbumes y paquetes físicos.</p>
            </div>

            <div className="person-card">
              <div className="image-placeholder">Image</div>
              <h3>Artistas</h3>
              <p>Personas que quieren compartir sus productos musicales.</p>
            </div>
          </div>
        </section>
      </main>
